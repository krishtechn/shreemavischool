  ...
  return (
    <div className="row gx-0">
      <div
        ...
        style={{ backgroundImage: 'url(http://ctevt.org.np/uploads/images/QcQjexUadyxHvKKCsD3JfLG6x4Z77QDNGyyiigrA.jpeg)' }}
      />
      ...
      <div className="col-lg-6">
        <div className="p-10 p-md-11 p-lg-13">
          ...
          <p className="lead fs-lg">
            Lets make something great together. We are trusted by over 5000+ Students. Join them by using our services
