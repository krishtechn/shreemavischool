...
const Footer: FC = () => {
  return (
    <footer className="text-inverse" style={{backgroundColor:"#373174"}}>
      <div className="container py-13 py-md-15">
        <div className="row gy-6 gy-lg-0">
          <div className="col-md-4 col-lg-3">
            <div className="widget">
              {/* <img className="mb-4" src="/img/logo-light.png" srcSet="/img/logo-light@2x.png 2x" alt="" /> */}
              <p className="mb-4 text-white fs-20">
              SHREE MA. VI SECONDARY SCHOOL. 
              </p>

              <p className="mb-4">
                © {new Date().getFullYear()} SHREE MA. VI SECONDARY SCHOOL. <br className="d-none d-lg-block" />
                All rights reserved.
              </p>
          ...
          <div className="col-md-4 col-lg-3">
            <div className="widget">
              ...
              <address className="pe-xl-15 pe-xxl-17">Digambarpur, Kshireshwornath, Dhanusha.</address>
              <NextLink title="krishkharal@gmail.com" href="mailto:#" />
              <br /> 9817173283
            </div>
          </div>
